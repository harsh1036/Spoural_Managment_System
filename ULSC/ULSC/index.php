...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($ulsc_id) && !empty($password)) {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            $_SESSION['ulsc_id'] = $user['id'];
            echo "<script>window.location.href='pages/ulscdashboard.php';</script>";
            exit();
        } else {
            echo "<script>alert('Invalid ULSC ID or Password');</script>";
        }
    } else {
                ...
                <div class="formbg-outer">
                    <div class="formbg">
                        <div class="formbg-inner padding-horizontal--48">
                            <span class="padding-bottom--15">Login to ULSC</span>
