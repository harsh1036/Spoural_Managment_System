...
// Event Title
$pdf->Cell(0, 10, 'Sports Event: ' . $event['event_name'], 0, 1);
...
foreach ($participants as $participant) {
    ...
    $pdf->Cell(25, 10, $participant['is_captain'] ? 'Captain' : 'Player', 1, 1, 'C', $fill);
    $fill = !$fill;
}

// Output the PDF
$filename = 'Sports_Event_' . $event['event_name'] . '_' . date('Y-m-d') . '.pdf';
