        ...
        <div class="participant-entry-container">
            <div class="content-card">
                ...
                <div class="quick-access-grid">
                    <a href="singleviewcultural.php" class="quick-access-card">
                        <i class='bx bx-detail'></i>
                        <h3>View Single Event</h3>
                        <p>View participants for a specific cultural event</p>
                    </a>
                    
                    <a href="allviewcultural.php" class="quick-access-card">
                        <i class='bx bx-list-ul'></i>
                        <h3>View Multiple Events</h3>
                        <p>See all cultural events and participants</p>
                    </a>
                </div>
            </div>
            ...
            <div class="content-card">
                <div class="content-header">
                    <h2><i class='bx bx-info-circle'></i> Cultural Events Information</h2>
                </div>
                <div class="card-content">
                    <p>Use the options above to view your department's participation in various cultural events. You can:</p>
                    <ul>
                        <li>View the list of students registered for a specific cultural event</li>
                        <li>Manage captains and participants for each event</li>
                        <li>View all cultural event registrations at once</li>
                    </ul>
                </div>
            </div>
        </div>
