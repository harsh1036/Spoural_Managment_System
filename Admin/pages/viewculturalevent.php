...
$all_events = $dbh->query("SELECT * FROM events WHERE event_type = 'Cultural' ORDER BY event_name")->fetchAll(PDO::FETCH_ASSOC);
    ...
    <div class="participant-entry-container">
        <div class="content-card">
            ...
            <div class="card-container">
                ...
                <div class="upload-card" id="departmentWiseCard">
                    ...
                    <p class="card-subtitle">View all cultural participants from a department</p>
                </div>
            </div>
        </div>
        ...
        <div class="content-card" id="eventWiseContent" style="display:none;">
            ...
            <div class="main-content">
                <form id="eventWiseForm" method="POST" action="viewculturalevent.php">
                ...
                if (isset($_POST['eventwise_event_id']) && $_POST['eventwise_event_id'] != '') {
                    ...
                    if (!empty($participants)) {
                        ...
                        echo "</tbody></table>";
                        // Download button (update to your download logic if needed)
                        echo "<form method='POST' action='download_Cultural_pdf.php' style='margin-top: 20px;'>";
        ...
        <div class="content-card" id="departmentWiseContent" style="display:none;">
            ...
            <div class="main-content">
                <form id="departmentWiseForm" method="POST" action="viewculturalevent.php">
                ...
                if (isset($_POST['deptwise_dept_id']) && $_POST['deptwise_dept_id'] != '') {
                    ...
                    $query = $dbh->prepare("
                        ...
                        LEFT JOIN student s ON p.student_id = s.student_id
                        WHERE p.dept_id = :dept_id AND e.event_type = 'Cultural'
                    ...
                    if (!empty($participants)) {
                        echo "<section class='view-admin-details'>";
                        echo "<h2 class='cntr'>Cultural Participants for Department: " . htmlspecialchars($dept_name) . "</h2>";
                        ...
                        echo "<div class='empty-message'>No cultural participants found for this department.</div>";
                    }
                }
                ?>
                </div>
